...
**list** : <span class='type_annotation'> list[Collection], </span><p> the p-cofaces of sigma </p>
...
**list** : <span class='type_annotation'> Union[numpy.typing.ArrayLike, int], </span><p> degree of each vertex id given in 'vertices' </p>
...
**simplices** : <span class='type_annotation'> Iterable[Collection], </span>required<p> 
